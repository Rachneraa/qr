  ...
  <div class="container">
    ...
    <form id="setupForm">
      <div class="form-group">
        <label for="mapsLinkInput">\u{1F4CD} Link Google Maps Toko / Place ID</label>
      ...
      <div class="form-group">
        <label for="businessName">\u{1F3EC} Nama Toko / Bisnis (Otomatis)</label>
...
<body>
  <div class="container">
    ...
    <a href="{{TARGET_URL}}" class="btn-test-now">\u{1F680} Buka Halaman Review Sekarang</a>
